...
@SpringBootTest
class GetRecursoUseCaseTest {

    @MockBean
    private RepositorioRecurso repositorioRecurso;
    @SpyBean
    private GetRecursoUseCase getRecursoUseCase;
    ...
    public void get() {
        ...
        var respuesta = getRecursoUseCase.apply("xxx");
        Assertions.assertEquals(respuesta.block().getId(), recursoDTO.getId());
    }
}