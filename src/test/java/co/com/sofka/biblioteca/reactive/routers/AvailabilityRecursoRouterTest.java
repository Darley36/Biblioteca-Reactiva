...
@ContextConfiguration(classes = {AvailabilityRecursoRouter.class, AvailabilityRecursoUseCase.class, MapperUtils.class})
class AvailabilityRecursoRouterTest {
    ...
    void listRecursoRouter() {
        ...
        webTestClient.get()
                .uri("/get/disponible/xxx")
                .exchange()
                .expectStatus().isOk()
                .expectBody(String.class)
                .value(userResponse -> {
                    Assertions.assertThat(userResponse).isEqualTo("El recurso se encuentra disponible");
                });
    }
}