...
@ContextConfiguration(classes = {RecommendTypeRouter.class, RecommendTypeUseCase.class, MapperUtils.class})
class RecommendTypeRouterTest {
    ...
    void RecommendTypeRouter() {
        ...
        when(repositorioRecurso.findByType("Libro")).thenReturn(Flux.just(recurso));
        webTestClient.get()
                .uri("/getAllportipo/Libro")
                .exchange()
                .expectStatus().isOk()
